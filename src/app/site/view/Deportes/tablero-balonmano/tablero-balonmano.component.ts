...
declare var $: any;
@Component({
  selector: 'app-tablero-balonmano',
  animations: [
    trigger('flyInOut', [
  ...
  templateUrl: './tablero-balonmano.component.html',
  styleUrls: ['./tablero-balonmano.component.css']
})
export class TableroBalonmanoComponent implements OnInit {
  jugadorA:any;
  jugadorB:any;
