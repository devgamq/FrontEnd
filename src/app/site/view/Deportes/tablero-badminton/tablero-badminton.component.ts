...
@Component({
  selector: 'app-tablero-badminton',
  animations: [
    trigger('flyInOut', [
  ...
  templateUrl: './tablero-badminton.component.html',
  styleUrls: ['./tablero-badminton.component.css']
})
export class TableroBadmintonComponent implements OnInit {
  equipoA = '';
  equipoB = '';
  prueba = 1;
  DelegacionIdA = -1;
  ...
  private cargarPeriodos(data: any) {
    ...
    let itemA = [];
    itemA.push(this.equipoA);
    // tslint:disable-next-line:prefer-const
    let itemB = [];
    itemB.push(this.equipoB);
  ...
  socketService(c) {
    ...
    changeVisor.subscribe(data => {
      ...
      this.equipoA = data['nameA'];
      this.equipoB = data['nameB'];
      ...
      this.urlA = '../../../../../assets/erpHammer/badminton/' + this.CompetidorAId + '.jpg';
      this.urlB = '../../../../../assets/erpHammer/badminton/' + this.CompetidorBId + '.jpg';
      ...
      if (this.PersonasEquipoA.length > 1) {
        this.urlA1 = '../../../../../assets/erpHammer/badminton/' + this.PersonasEquipoA[0].PersonaId + '.jpg';
        this.urlA2 = '../../../../../assets/erpHammer/badminton/' + this.PersonasEquipoA[1].PersonaId + '.jpg';
      ...
      if (this.PersonasEquipoB.length > 1) {
        this.urlB1 = '../../../../../assets/erpHammer/badminton/' + this.PersonasEquipoB[0].PersonaId + '.jpg';
        this.urlB2 = '../../../../../assets/erpHammer/badminton/' + this.PersonasEquipoB[1].PersonaId + '.jpg';
      ...
      if (this.PersonasSelectA.length > 0) {
        this.urlA1 = '../../../../../assets/erpHammer/badminton/' + String(this.PersonasSelectA[0]).split('|')[0] + '.jpg';
        this.urlA2 = '../../../../../assets/erpHammer/badminton/' + String(this.PersonasSelectA[1]).split('|')[0] + '.jpg';
      ...
      if (this.PersonasSelectB.length > 0) {
        this.urlB1 = '../../../../../assets/erpHammer/badminton/' + String(this.PersonasSelectB[0]).split('|')[0] + '.jpg';
        this.urlB2 = '../../../../../assets/erpHammer/badminton/' + String(this.PersonasSelectB[1]).split('|')[0] + '.jpg';
      ...
      if (this.PersonasSelectA.length === 1 || this.PersonasSelectB.length === 1) {
        this.urlA = '../../../../../assets/erpHammer/badminton/' + String(this.PersonasSelectA[0]).split('|')[0] + '.jpg';
        this.urlB = '../../../../../assets/erpHammer/badminton/' + String(this.PersonasSelectB[0]).split('|')[0] + '.jpg';
