...
@Component({
  selector: 'app-tablero-pelota-vasca',
  animations: [
    trigger('flyInOut', [
  ...
  templateUrl: './tablero-pelota-vasca.component.html',
  styleUrls: ['./tablero-pelota-vasca.component.css']
})
export class TableroPelotaVascaComponent implements OnInit {
  ...
  socketService(c) {
    ...
    changeVisor.subscribe(data => {
      ...
      this.urlA = '../../../../../assets/erpHammer/pelota_vasca/' + this.CompetidorAId + '.jpg';
      this.urlB = '../../../../../assets/erpHammer/pelota_vasca/' + this.CompetidorBId + '.jpg';
      ...
      if (this.PersonasEquipoA.length > 1) {
        this.urlA1 = '../../../../../assets/erpHammer/pelota_vasca/' + this.PersonasEquipoA[0].PersonaId + '.jpg';
        this.urlA2 = '../../../../../assets/erpHammer/pelota_vasca/' + this.PersonasEquipoA[1].PersonaId + '.jpg';
      ...
      if (this.PersonasEquipoB.length > 1) {
        this.urlB1 = '../../../../../assets/erpHammer/pelota_vasca/' + this.PersonasEquipoB[0].PersonaId + '.jpg';
        this.urlB2 = '../../../../../assets/erpHammer/pelota_vasca/' + this.PersonasEquipoB[1].PersonaId + '.jpg';
