...
declare var $: any;
@Component({
  selector: 'app-tablero-raquetbol',
  animations: [
    trigger('flyInOut', [
  ...
  templateUrl: './tablero-raquetbol.component.html',
  styleUrls: ['./tablero-raquetbol.component.css']
})
export class TableroRaquetbolComponent implements OnInit {
  minA = 0;
  minB = 0;
  apeA = 0;
  apeB = 0;
  ...
  socketService(c) {
    ...
    changeVisor.subscribe(data => {
      ...
      this.prueba = String(data['prueba']).includes('ingles') ? 1 : 2;
