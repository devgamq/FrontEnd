...
@Component({
  selector: 'app-control-visor-deporte',
  templateUrl: './control-visor-deporte.component.html',
  styleUrls: ['./control-visor-deporte.component.css'],
  providers: [/*SocketService,*/ CategoriaService]
})
export class ControlVisorDeporteComponent implements OnInit {
