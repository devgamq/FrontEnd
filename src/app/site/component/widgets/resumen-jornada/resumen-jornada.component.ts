...
@Component({
  selector: 'app-resumen-jornada',
  templateUrl: './resumen-jornada.component.html',
  styleUrls: ['./resumen-jornada.component.css'],
  encapsulation: ViewEncapsulation.None,
  providers: [PodioService, ConjuntoService]
})
export class ResumenJornadaComponent implements OnInit, OnChanges, AfterViewInit {
  data: any[];
  datos: any[];
  masterData: any[];
