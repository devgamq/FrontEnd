...
@Component({
  selector: 'app-cronometro-balonmano-d',
  templateUrl: './cronometro-balonmano-d.component.html',
  styleUrls: ['./cronometro-balonmano-d.component.css']
})

export class CronometroBalonmanoDComponent implements OnInit, OnChanges {
  hora: number;
  minuto: number;
  segundo: number;
  capturas: Array<any>;
