...
@Component({
  selector: 'app-cronometro-balonmano',
  templateUrl: './cronometro-balonmano.component.html',
  styleUrls: ['./cronometro-balonmano.component.css']
})

export class CronometroBalonmanoComponent implements OnInit, OnChanges {
  hora: number;
  minuto: number;
  segundo: number;
  capturas: Array<any>;
