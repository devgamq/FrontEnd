  ...
  OrgChart.prototype = {
    ...
    createNode: function (nodeData, level, opts) {
      ...
      if (opts.nodeTemplate) {
        ...
        $nodeDiv.append('<div class="title"><img src="../../../assets/0'+nodeData["evento"]+
        '/banderas/'+nodeData["delegacion"]+'.png"/>' + nodeData[opts.nodeTitle] + '</div>')
          .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content">' + (nodeData[opts.nodeContent] || '') + '</div>'+
          '<div class="puntos">'+nodeData["puntos"]+'</div>' : '');
      }
